...
export const adminService = {
  ...
  getExplorerDestinations: () => api.get('/admin/explorer-destinations'),
  createExplorerDestination: (data) => api.post('/admin/explorer-destinations', data),
  updateExplorerDestination: (id, data) => api.patch(`/admin/explorer-destinations/${id}`, data),
  deleteExplorerDestination: (id) => api.delete(`/admin/explorer-destinations/${id}`),
